...
# Description: Defines the core Multi-Task Cross-Attention Module.
...
class MultiTaskCrossAttentionModule(nn.Module):
    """
    Implements the Multi-Task Cross-Attention Module.
    ...
    def forward(
        ...
        """
        Performs symmetric cross-attention, applying a functional pipeline style.
