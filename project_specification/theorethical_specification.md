...
The specific mappings are detailed in the [Technical Specification](./technical_specification.md#3-data-pipeline-components).
...
The detailed implementation of the architecture can be found in the [Technical Specification](./technical_specification.md#4-model-architecture-components).
...
The technical implementation, including optimizations like parallel processing and JIT compilation, is described in the [Technical Specification](./technical_specification.md#3-data-pipeline-components) and the PDS launcher scripts.
...
A full list of applied augmentations is available in the [Technical Specification](./technical_specification.md#34-segmentation-augmentation-pipeline).
...
Specific hyperparameters are listed in the [Technical Specification](./technical_specification.md#54-optimizer-factory).
...
The formulas and their implementation context are in the [Technical Specification](./technical_specification.md#6-metrics-components) and [Three-Tier Metrics](./Metrics_Three_Tier_Extended.md).
